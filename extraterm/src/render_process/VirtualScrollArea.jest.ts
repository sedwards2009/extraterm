...
test("long", () => {
  ...
  expect(scrollbar.position).toBe(1000);
  expect(scrollbar.length).toBe(1500);
  expect(scrollable.getScrollOffset()).toBe(1000);

  vsa.scrollTo(750);
  expect(scrollbar.position).toBe(750);
...
test("3 Scrollables", () => {
  ...
  expect(scrollbar.position).toBe(4000);
  expect(scrollbar.length).toBe(4500);
  ...
  vsa.scrollTo(1500);
  expect(scrollbar.position).toBe(1500);
  ...
  vsa.scrollTo(2500);
  expect(scrollbar.position).toBe(2500);
  expect(container.scrollTop).toBe(500);
  expect(scrollable1.getScrollOffset()).toBe(1000);
  ...
  vsa.scrollTo(3500);
  expect(scrollbar.position).toBe(3500);
...
test("ShortWithReserve", () => {
  ...
  expect(scrollable.getScrollOffset()).toBe(0);
  expect(scrollbar.length).toBe(700);
});
