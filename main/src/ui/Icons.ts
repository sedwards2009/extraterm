...
interface FontAwesomeMetadata {
  [key: string]: FontAwesomeIconMetadata;
}

// Note: The contents of this table is generated with format_font_awesome_metadata.js
//       from the FontAwesome icon metadata.
const fontAwesomeIcons: FontAwesomeMetadata = {
