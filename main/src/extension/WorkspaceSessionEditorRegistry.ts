...
import { ExtensionMetadata, ExtensionSessionEditorContribution } from './ExtensionMetadata';
import { InternalSessionEditor, SessionConfigurationChange } from '../InternalTypes';
