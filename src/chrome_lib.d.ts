...
declare class HTMLElement implements MSEventAttachmentTarget, ElementCSSInlineStyle, Element, MSNodeExtensions {
...
declare class HTMLTableElement extends HTMLElement implements DOML2DeprecatedBackgroundStyle, MSDataBindingExtensions, MSDataBindingTableExtensions, DOML2DeprecatedBackgroundColorStyle {
    background: string;
    dataSrc: string;
    dataFormatAs: string;
    dataFld: string;
...
declare class HTMLAppletElement extends HTMLElement implements DOML2DeprecatedMarginStyle, DOML2DeprecatedAlignmentStyle, MSDataBindingExtensions, DOML2DeprecatedBorderStyle, MSDataBindingRecordSetExtensions {
    vspace: number;
    hspace: number;
    align: string;
    dataSrc: string;
...
declare class HTMLFontElement extends HTMLElement implements DOML2DeprecatedSizeProperty, DOML2DeprecatedColorProperty {
    size: number;
    color: string;
    /**
...
declare class HTMLImageElement extends HTMLElement implements MSResourceMetadata, MSDataBindingExtensions, MSImageResourceExtensions {
    protocol: string;
    fileSize: string;
...
declare class HTMLHRElement extends HTMLElement implements DOML2DeprecatedSizeProperty, DOML2DeprecatedColorProperty {
    size: number;
    color: string;
    /**
      * Sets or retrieves the width of the object.
...
declare class HTMLObjectElement extends HTMLElement implements DOML2DeprecatedMarginStyle, DOML2DeprecatedAlignmentStyle, GetSVGDocument, MSDataBindingExtensions, DOML2DeprecatedBorderStyle, MSDataBindingRecordSetExtensions {
    vspace: number;
    hspace: number;
    align: string;
    getSVGDocument(): Document;
